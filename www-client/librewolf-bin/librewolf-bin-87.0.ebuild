...
SRC_URI="${SRC_URI}
	amd64? ( https://gitlab.com/librewolf-community/browser/linux/uploads/87630bd04e5a581bf9250e5c81dce80a/librewolf-87.0-1-x86_64.pkg.tar.zst -> ${PN}_x86_64-${PV}.tar.zst )"
