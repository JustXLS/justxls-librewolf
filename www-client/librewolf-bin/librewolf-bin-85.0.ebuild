...
SRC_URI="${SRC_URI}
	amd64? ( https://gitlab.com/librewolf-community/browser/linux/uploads/948e253c75e3bc793491c8ad68a27024/librewolf-85.0-1-x86_64.pkg.tar.zst -> ${PN}_x86_64-${PV}.tar.zst )"
