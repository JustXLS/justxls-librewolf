...
SRC_URI="${SRC_URI}
	amd64? ( https://gitlab.com/librewolf-community/browser/linux/uploads/e81743137785237da11cb5efe1f88ef0/librewolf-86.0-1-x86_64.pkg.tar.zst -> ${PN}_x86_64-${PV}.tar.zst )"
