...
SRC_URI="${SRC_URI}
	amd64? ( https://gitlab.com/librewolf-community/browser/linux/uploads/24f83f79bfd15e0cb2cf85856ca3163d/librewolf-85.0.1-1-x86_64.pkg.tar.zst -> ${PN}_x86_64-${PV}.tar.zst )"
