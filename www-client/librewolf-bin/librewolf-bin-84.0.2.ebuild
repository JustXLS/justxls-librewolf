...
SRC_URI="${SRC_URI}
	amd64? ( https://gitlab.com/librewolf-community/browser/linux/uploads/55ee6af4d63896e6cdd5b244e463fa7e/librewolf-84.0.2-1-x86_64.pkg.tar.zst -> ${PN}_x86_64-${PV}.tar.zst )"
